...
(function() {
    ...
    $(function() {
        var animationInstance = new Animation(document.querySelectorAll('.siteKeyvisual')[0]);

        $('[data-code]').each(function(index, element) {
            var $el = $(element);
            var $code = $('<pre><code class="language-markup"></code></pre>');
            var someHtmlString = $el.html();
            var escaped = $code.find('code').text(someHtmlString).html();
